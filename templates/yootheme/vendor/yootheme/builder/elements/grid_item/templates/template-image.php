...
if ($props['image']) {
    ...
    $image = $this->el('image', [
        ...
        'class' => [
            ...
            'uk-box-shadow-hover-{image_hover_box_shadow} {@!panel_style} {@link_type: element}' => $props['link'],
            'uk-text-{image_svg_color} {@image_svg_inline}' => $this->isImage($props['image']) == 'svg',
            'uk-margin[-{image_margin}]-top {@!image_margin: remove} {@!image_box_decoration}' => $element['image_align'] == 'between' || ($element['image_align'] == 'bottom' && !$element['panel_card_image']),
        ],
...
// Icon
    ...
    $icon = $this->el('span', [
        ...
        'class' => [
            'el-image',
            'uk-text-{icon_color}',
            'uk-margin[-{image_margin}]-top {@!image_margin: remove}' => $element['image_align'] == 'between' || ($element['image_align'] == 'bottom' && !$element['panel_card_image']),
        ],
